...
class ChatVC: JSQMessagesViewController, MessageReceivedDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView!, messageBubbleImageDataForItemAt indexPath: IndexPath!) -> JSQMessageBubbleImageDataSource!
    {
        ...
        {
            return bubbleFactory?.outgoingMessagesBubbleImage(with: UIColor.magenta); //color for chatting
            
        } else
        {
            return bubbleFactory?.incomingMessagesBubbleImage(with: UIColor.magenta) ;
        }
    ...
    override func didPressAccessoryButton(_ sender: UIButton!) // this function is for sending images
    {
    ...
    func mediaReceived(senderID: String, senderName: String, url: String)
    {
        if let mediaURL = URL(string: url )
        {
            ...
            {  //here we gonna catch on pontential error that we gonna get
